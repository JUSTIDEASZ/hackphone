...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to Phonehack Pro?{color.WHITE}     Y / N > "
        ).lower()
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to PhoneHack/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
